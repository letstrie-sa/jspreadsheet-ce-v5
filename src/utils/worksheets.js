...
const createTable = function () {
  ...
  // row-height
  if (obj.options.rows) {
    const rowHeight = obj.options.rows;
    for (let key in rowHeight) {
      if (key in rowHeight && "height" in rowHeight[key]) {
        obj.setHeight(key, rowHeight[key].height, undefined, true);
      }
    }
  }
};
...
const worksheetPublicMethods = [
  ...
  [
    "setWidth",
    function (column, width, oldWidth, ignoreHistory) {
      return setWidth.call(this, column, width, oldWidth, ignoreHistory);
    },
  ],
  ["insertRow", insertRow],
  [
  ...
  [
    "setHeight",
    function (row, height, oldHeight, ignoreHistory) {
      return setHeight.call(this, row, height, oldHeight, ignoreHistory);
    },
  ],
  ["getMerge", getMerge],
  [
  ...
  [
    "setStyle",
    function (cell, property, value, forceOverwrite, ignoreHistoryAndEvents) {
