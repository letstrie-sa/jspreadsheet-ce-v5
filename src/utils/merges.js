...
export const SA_setMerge = function ({
  ...
  let askingForUnMerge =
    !!obj.records[topLeftX][topLeftY].element.getAttribute("data-merged");
  ...
  backup.value =
    mergeMode === "combine" ? backup.spaceSeparatedValue : backup.topLeftValue;
  ...
  if (colspan > 1)
    obj.records[topLeftX][topLeftY].element.setAttribute("colspan", colspan);
  if (rowspan > 1)
    obj.records[topLeftX][topLeftY].element.setAttribute("rowspan", rowspan);
  ...
  obj.records[topLeftX][topLeftY].element.setAttribute(
    "data-merge-src",
    cellName
  );
  ...
  if (mergeMode === "combine") {
    obj.records[topLeftX][topLeftY].element.style.lineHeight =
      (obj.options.defaultRowHeight ?? 25) + "px";
    setStyle.call(
      obj,
      cellName,
      "lineHeight",
...
export const SA_removeMerge = function ({
  ...
  updateSelection.call(
    obj,
    obj.records[x][y].element,
    obj.records[x + rs - 1][y + cs - 1].element
  );
